  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[minmax(0,1fr)_auto] lg:grid-cols-[minmax(0,1fr)_minmax(17.5rem,19rem)] lg:grid-rows-1">
          <section
            className="flex min-h-0 min-w-0 flex-col border-[var(--border)] lg:border-r"
              ...
              <table className="w-full table-fixed border-collapse text-left text-xs">
                ...
                <thead className="sticky top-0 z-[1] bg-[var(--surface)] shadow-[0_1px_0_var(--border)]">
                  <tr className="text-[10px] font-semibold uppercase tracking-wide text-[var(--muted)]">
                    <th className="px-2 py-2 font-semibold sm:px-3">Zeit</th>
                    <th className="px-1.5 py-2 font-semibold">Typ</th>
                    <th className="px-1.5 py-2 font-semibold">Team / Aktivität</th>
                    <th className="hidden px-1.5 py-2 font-semibold md:table-cell">Anlage</th>
                    <th className="hidden px-1.5 py-2 font-semibold lg:table-cell">Garderobe</th>
                    ...
                    visibleItems.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="hidden truncate px-1.5 py-1.5 text-[var(--text-2)] md:table-cell">
                            {itemInspectionPitchLabel(item)}
                          </td>
                          <td className="hidden truncate px-1.5 py-1.5 text-[var(--text-2)] lg:table-cell">
          ...
          <aside
            className="flex min-h-0 w-full flex-col border-t border-[var(--border)] bg-[var(--surface)] lg:border-t-0"
