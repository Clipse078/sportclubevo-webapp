    ...
    <div className={cn("flex flex-wrap gap-2", className)}>
      {actions.map((action) => (
        <Link
          ...
          href={action.href}
          className={cn(
            "inline-flex min-h-[2.25rem] items-center gap-2 rounded-[var(--radius-md)] border border-[var(--border)]",
            "bg-[var(--surface)] px-3 py-1.5 text-[0.8125rem] font-medium text-[var(--foreground)] no-underline",
