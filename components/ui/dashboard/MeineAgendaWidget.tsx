    ...
    >
      {!supported ? (
        <DashboardEmptyState
          ...
          description="Verknüpfe dein Benutzerkonto mit einer Person und Teamfunktion, um persönliche Termine zu sehen."
        />
      ) : items.length === 0 ? (
        <DashboardEmptyState
          icon={<CalendarDays className="h-5 w-5" />}
          title="Keine persönlichen Termine"
          description="Trainings, Spiele und Meetings deiner Teams erscheinen hier."
        />
      ) : (
