...
export const LUCIDE_DEFAULT_SEMANTIC: Record<string, DefaultRule> = {
  ...
  Images: { category: "CONTENT_IDENTITY", reason: "Image gallery / media content" },
  ImageIcon: { category: "CONTENT_IDENTITY", reason: "Image media type marker" },
  FileText: { category: "UTILITY_ACTION", reason: "Document/file metaphor" },
  Trophy: { category: "DECORATIVE", reason: "Achievement / trophy decorative unless competition context" },
  Target: { category: "UTILITY_ACTION", reason: "Targeting / filter metaphor unless club goal context" },
  Lightbulb: { category: "UTILITY_ACTION", reason: "Idea / hint affordance unless initiative domain" },
  Package: { category: "UTILITY_ACTION", reason: "Package / shipment affordance unless inventory module" },
  Blocks: { category: "UTILITY_ACTION", reason: "Layout blocks UI unless block library domain" },
  LayoutTemplate: { category: "UTILITY_ACTION", reason: "Layout template picker unless homepage builder" },
  ...
  Bell: { category: "STATUS_STATE", reason: "Notification indicator" },
  ListChecks: { category: "UTILITY_ACTION", reason: "Checklist / task list UI" },
  Settings: { category: "UTILITY_ACTION", reason: "Settings affordance (generic)" },
  Settings2: { category: "UTILITY_ACTION", reason: "Settings affordance (generic)" },
  Image: { category: "CONTENT_IDENTITY", reason: "Image content / media picker" },
  Video: { category: "CONTENT_IDENTITY", reason: "Video content" },
  Smartphone: { category: "UTILITY_ACTION", reason: "Mobile viewport preview" },
  Tablet: { category: "UTILITY_ACTION", reason: "Tablet viewport preview" },
  Underline: { category: "UTILITY_ACTION", reason: "Rich-text formatting" },
  Users2: { category: "CONTENT_IDENTITY", reason: "People group content reference" },
  FileStack: { category: "SCE_DOMAIN_APPROVED", sceMaster: "documents", reason: "Document stack domain" },
  Signature: { category: "UTILITY_ACTION", reason: "Signature capture UI" },
  PackageCheck: { category: "STATUS_STATE", reason: "Package verified state" },
  PanelsTopLeft: { category: "UTILITY_ACTION", reason: "Layout panel affordance" },
  Plane: { category: "UTILITY_ACTION", reason: "Travel / away metaphor in planner UI" },
  Bus: { category: "UTILITY_ACTION", reason: "Transport logistics affordance" },
  PackageX: { category: "STATUS_STATE", reason: "Missing / excluded package state" },
  UserSquare2: { category: "CONTENT_IDENTITY", reason: "User account tile" },
  FileDown: { category: "UTILITY_ACTION", reason: "Download file action" },
  Map: { category: "SCE_DOMAIN_APPROVED", sceMaster: "facility", reason: "Map / facility plan surface" },
  Code2: { category: "UTILITY_ACTION", reason: "Embed / code snippet UI" },
  GraduationCap: { category: "CONTENT_IDENTITY", reason: "Youth / education program marker" },
  UserCheck2: { category: "STATUS_STATE", reason: "Verified user state" },
  UserRoundSearch: { category: "UTILITY_ACTION", reason: "User search affordance" },
  CircleCheck: { category: "STATUS_STATE", reason: "Completed step indicator" },
  CircleDashed: { category: "STATUS_STATE", reason: "Pending step indicator" },
  ClockAlert: { category: "STATUS_STATE", reason: "Overdue time warning" },
  LoaderCircle: { category: "STATUS_STATE", reason: "Loading spinner" },
};
...
const CONTEXT_OVERRIDES: Array<{
  ...
  {
    symbol: "Trophy",
    snippetPattern: /TOURNAMENT|Turnier|tournamentcenter|tournament-semantic/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "tournament",
      reason: "Tournament activity / turnier domain",
    },
  },
  {
    symbol: "Trophy",
    snippetPattern: /veranstaltungen-kpi-total|kpi-total|key: \"total\"|COMPETITION|Wettkampf|competition|Kein Wettbewerb/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "competition",
      reason: "Competition / wettkampf domain",
    },
  },
  {
    symbol: "Trophy",
    filePattern: /competitions\//,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "competition",
      reason: "Competitions module",
    },
  },
  {
    symbol: "Trophy",
    filePattern: /veranstaltungen\/VeranstaltungenManagementWorkspace/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "competition",
      reason: "Veranstaltungen total/competition KPI",
    },
  },
  {
    symbol: "Users",
    filePattern: /target-groups/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "target-group",
      reason: "Target groups module",
    },
  },
  {
    symbol: "FileText",
    filePattern: /website\/page\.tsx|WebsitePageList|cms\/sections|website\/pages/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "page",
      reason: "CMS static website page",
    },
  },
  {
    symbol: "ImageIcon",
    filePattern: /website\/page\.tsx|MediaLibraryDAM|SharedMediaPicker|NewsHeroMediaPicker/,
    snippetPattern: /Mediathek|Medien|media-library|MediaLibrary/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "media-library",
      reason: "Media library / DAM domain",
    },
  },
  {
    symbol: "Blocks",
    filePattern: /website\/(page|blocks)|block-library|ReusableComponents|block-registry/,
    snippetPattern: /Block-Bibliothek|block-library|Blocks/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "block-library",
      reason: "CMS block library domain",
    },
  },
  {
    symbol: "LayoutTemplate",
    filePattern: /website\/page\.tsx|homepage-builder|HomepageBuilder|HomepageCanvasEmpty/,
    snippetPattern: /Homepage Builder|homepage-builder|LayoutTemplate/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "homepage-builder",
      reason: "Homepage builder domain",
    },
  },
  {
    symbol: "Menu",
    filePattern: /website\/page\.tsx/,
    snippetPattern: /Navigation|Schnellzugriff|website-navigation/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "website-navigation",
      reason: "Website navigation tree configuration",
    },
  },
  {
    symbol: "Target",
    filePattern: /club-entwicklung|target-groups|vereinsleitung\/targets/,
    snippetPattern: /Ziele|goal|Entwicklung/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "goal",
      reason: "Club development goals",
    },
  },
  {
    symbol: "Lightbulb",
    filePattern: /club-entwicklung/,
    snippetPattern: /Initiativen|initiative/i,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "initiative",
      reason: "Club development initiatives",
    },
  },
  {
    symbol: "Package",
    filePattern: /vereinsleitung\/material|material-inventory/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "material-inventory",
      reason: "Material & inventory module",
    },
  },
  {
    symbol: "User",
  ...
  {
    symbol: "Hourglass",
    filePattern: /warteliste|WaitingList/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "waiting-list",
      reason: "Waiting list queue semantics",
    },
  },
  {
    symbol: "ShieldAlert",
    filePattern: /vorfaelle-disziplin|future-modules/,
    rule: {
      category: "SCE_DOMAIN_APPROVED",
      sceMaster: "discipline-incident",
      reason: "Discipline incidents module",
    },
  },
  {
    symbol: "ShieldAlert",
    snippetPattern: /RegistrationWorkflow|workflow panel|Warnung/i,
    rule: { category: "STATUS_STATE", reason: "Registration warning / status" },
  },
  {
    symbol: "Menu",
