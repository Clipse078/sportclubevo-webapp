...
export function workspaceAuditActionLabel(action: string): string {
  ...
  const labels: Record<string, string> = {
    ...
    WORKSPACE_BREAK_GLASS_ACTIVATED: "Break-Glass aktiviert",
    WORKSPACE_BREAK_GLASS_USED: "Break-Glass Zugriff",
    WORKSPACE_BREAK_GLASS_ENDED: "Break-Glass beendet",
    WORKSPACE_BREAK_GLASS_REVOKED: "Break-Glass widerrufen",
