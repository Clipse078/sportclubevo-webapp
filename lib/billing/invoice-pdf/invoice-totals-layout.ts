...
export const TOTALS_VAT_TO_GROSS_GAP_MM = 7;
export const TOTALS_DIVIDER_OFFSET_MM = 2;
export const TOTALS_GROSS_HIGHLIGHT_HEIGHT_MM = 8;
export const TOTALS_GROSS_TEXT_INSET_MM = 2;

export function minimumVatToGrossSeparationMm(): number {
  return TOTALS_VAT_TO_GROSS_GAP_MM;
}
